// Business data for Brgy. Sta. Cruz, Santa Maria, Bulacan
// This data structure matches your CSV format - easy to replace with real CSV data
...
export const businesses: Business[] = [
    ...
    { business_id: 22, business_name: "JWNs Talipapa & Sari Sari Store", category: "Retail", latitude: 14.83763, longitude: 120.95820, street: "Bukid St.", zone_type: "Commercial" },
...
// Helper function to get businesses by zone type
export function getBusinessesByZone(zoneType: string): Business[] {
    return businesses.filter(b => b.zone_type.toLowerCase() === zoneType.toLowerCase());
}
